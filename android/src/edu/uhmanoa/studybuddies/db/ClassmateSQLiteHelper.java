...
public class ClassmateSQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE_NAME + "(" + COLUMN_EMAIL + " text not null," + COLUMN_NAME + " text not null," + COLUMN_CLASS_NAME + " text not null," + COLUMN_PENDING_CREATION + " int not null,"+ COLUMN_CONFIRMED_CREATION + " int not null" + ")";
